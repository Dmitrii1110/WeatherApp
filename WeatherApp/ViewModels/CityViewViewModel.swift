...
final class CityViewViewModel: ObservableObject {
    ...
    private lazy var dateForatter: DateFormatter = {
    ...
    var date: String {
        return dateForatter.string(from: Date(timeIntervalSince1970: TimeInterval(weather.current.dt)))
    }
    ...
    func getWeatherIconFor(icon: String) -> Image {
        ...
        case "02n":
            return Image(systemName: "cloud.sun.fill") //"few_clouds_night"
        case "03d":
        ...
        case "09n":
            return Image(systemName: "cloud.drizzle.fill") //"shower_rain"
        case "10d":
            return Image(systemName: "cloud.heavyrain.fill") //"rain"
        case "10n":
            return Image(systemName: "cloud.heavyrain.fill") //"rain"
        case "11d":
        ...
        case "13d":
            return Image(systemName: "cloud.show.fill") //"snow"
        case "13n":
            return Image(systemName: "cloud.show.fill") //"snow"
        case "50d":
